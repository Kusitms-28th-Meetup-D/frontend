...
//export type ContentsProps = IRecord | ISkill;
  ...
  return (
    <ProfileSubInfoContainer>
      <ProfileSubInfoBox>
        ...
        <ProfileSubInfoContents props1={activitiesData} props2={awardsData} />
      </ProfileSubInfoBox>
      <ProfileSubInfoBox>
        <ProfileSubInfoTitle>스킬</ProfileSubInfoTitle>
        <ProfileSubInfoContents props1={toolsData} props2={licensesData} />
      </ProfileSubInfoBox>
    </ProfileSubInfoContainer>
  );
};
